...
```bash
pnpm create react-app octofit-tracker/frontend --template cra-template

pnpm --dir octofit-tracker/frontend install bootstrap
...
pnpm --dir octofit-tracker/frontend install react-router-dom
